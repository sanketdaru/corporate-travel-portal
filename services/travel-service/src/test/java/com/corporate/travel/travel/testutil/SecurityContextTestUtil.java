...
public class SecurityContextTestUtil {
    ...
    public static SecurityContext aliceContext() {
        return createContext(BookingTestFixtures.ALICE_USER_ID, BookingTestFixtures.TENANT_A);
    }
    ...
    public static SecurityContext bobContext() {
        return createManagerContext(BookingTestFixtures.BOB_USER_ID, BookingTestFixtures.TENANT_A);
    }
    ...
    public static SecurityContext carolContext() {
        return createContext(BookingTestFixtures.CAROL_USER_ID, BookingTestFixtures.TENANT_A);
    }
    ...
    public static SecurityContext daveActingForCarolContext() {
        return createDelegatedContext(
                BookingTestFixtures.DAVE_USER_ID,
                BookingTestFixtures.CAROL_USER_ID,
                BookingTestFixtures.TENANT_A
        );
    }
    ...
    public static SecurityContext eveContext() {
        return createContext(BookingTestFixtures.EVE_USER_ID, BookingTestFixtures.TENANT_B);
    }
